...
export const DEMOS: DemoMeta[] = [
  ...
  },
  {
    id: "gravity-wells",
    title: "Gravity Wells",
    tagline: "Your hands bend the orbits of a particle galaxy",
    description:
      "Each hand becomes a gravity well. A thousand particles fall into orbit, slingshot and swirl around your palms — sculpt spiral galaxies and binary systems in the air.",
    glyph: "🪐",
    maturity: "stable",
    uses: ["MediaPipe Hands", "Physics"],
    facing: "user",
    accent: ["#5b8cff", "#b86bff"],
    component: lazy(() => import("./GravityWells")),
  },
  {
    id: "lightning-hands",
    title: "Lightning Hands",
    tagline: "Electricity arcs between your fingertips",
    description:
      "Crackling bolts leap from fingertip to fingertip and jump hand-to-hand when you bring them close. Spread your fingers, pinch for sparks, and channel the storm.",
    glyph: "⚡",
    maturity: "stable",
    uses: ["MediaPipe Hands", "Canvas"],
    facing: "user",
    accent: ["#9fd8ff", "#5b8cff"],
    component: lazy(() => import("./LightningHands")),
  },
  {
    id: "portal",
    title: "Portal",
    tagline: "Become a doorway into deep space",
    description:
      "Selfie segmentation fills your silhouette with a living cosmos — drifting nebulae and twinkling stars glow inside your shape while the world falls dark around you.",
    glyph: "🌀",
    maturity: "experimental",
    uses: ["MediaPipe Segmenter", "Generative"],
    facing: "user",
    accent: ["#7aa2ff", "#b86bff"],
    component: lazy(() => import("./Portal")),
  },
  {
    id: "slime",
    title: "Slime",
    tagline: "A living network that grows toward your hands",
    description:
      "A Physarum slime-mould simulation: thousands of agents deposit and chase a pheromone trail, self-organising into emergent, branching vein networks that creep toward your hands as you feed them. After Sage Jenson.",
    glyph: "🧫",
    maturity: "experimental",
    uses: ["Agent simulation", "MediaPipe Hands"],
    facing: "user",
    accent: ["#38e8c8", "#7CFC9A"],
    component: lazy(() => import("./Slime")),
  },
  {
    id: "morphogenesis",
    title: "Morphogenesis",
    tagline: "Turing patterns bloom from your silhouette",
    description:
      "Gray-Scott reaction-diffusion brought to life: your segmented body seeds a chemical that grows into coral, cells and fingerprint patterns spreading outward — the mathematics of how life forms its shapes.",
    glyph: "🌱",
    maturity: "experimental",
    uses: ["Reaction-diffusion", "MediaPipe Segmenter"],
    facing: "user",
    accent: ["#b86bff", "#ffb35b"],
    component: lazy(() => import("./Morphogenesis")),
  },
  {
    id: "currents",
    title: "Currents",
    tagline: "Stir a river of light with your hands",
    description:
      "A Perlin flow field rendered as thousands of agents painting silken ribbons of light along invisible currents. Your hands twist the field into vortices, letting you conduct the flow.",
    glyph: "🌊",
    maturity: "stable",
    uses: ["Flow field", "MediaPipe Hands"],
    facing: "user",
    accent: ["#5b8cff", "#38e8c8"],
    component: lazy(() => import("./Currents")),
  },
  {
    id: "reality-mesh",
    title: "Reality Mesh",
